...
const EditProfile = () => {
    ...
    function onSubmit(fields, { setStatus, setSubmitting }) {
        ...
        updateUser(userId, updateUserDetails).then(() => {
            alertService.success('User profile was updated', { keepAfterRouteChange: true });
            navigate('/feedpage')
        }).catch(error => {
            setSubmitting(false);
                                ...
                                <div className="signup-content">
                                    <div className="signup-form">
                                        ...
                                        <Form method="POST" className="register-form" id="register-form">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="phoneNumber"><i
                                                    className="zmdi zmdi-number"></i></label>
                                                <Field
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="confirmPassword"><i
                                                    className="zmdi zmdi-lock-outline"></i></label>
                                                <Field
                                    ...
                                    <div className="signup-image">
                                        ...
                                        <figure><img src="https://github.com/Sanjana-Nalawade/repoForAssetsOfProject/blob/main/undraw_personal_information_re_vw8a.png?raw=true"  height="500px" alt="sing up image"/></figure>
