            ...
            <section id="hero" className="hero">
                <div className="container position-relative">
                    <div className="row gy-5" data-aos="fade-in">
                        <div
                            className="col-lg-12  order-lg-1 d-flex flex-column justify-content-center text-center caption">
                            <h2>
                            ...
                            <div className="col-lg-8">
                                <div className="content ps-0 ps-lg-5">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <i className="bi bi-6-square"></i> The user can also
                                            edit
                                            their profile using edit option provided in the
                                            dashboard.
                                        </li>
                                        <li>
                                            <i className="bi bi-7-square"></i> Search option helps
                                            to
