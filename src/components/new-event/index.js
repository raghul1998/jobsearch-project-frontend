...
const NewEvent = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    organiserName: Yup.string().required("Orgnaiser name is required"),
    dateOfEvent: Yup.string().required("Date of event is required"),
    timeOfEvent: Yup.string().required("Time of event is required"),
    location: Yup.string().required("Location is required"),
    shortDescription: Yup.string().required("Event summary is required"),
    longDescription: Yup.string().required("Event description is required"),
  });
  ...
  function onSubmit(fields, { setStatus, setSubmitting }) {
    ...
    createEvent(newEvent)
      .then(() => {
        alertService.success("Event added successful", {
                    ...
                    <div className="card-body">
                      <div className="row">
                        ...
                        <div className="form-group col-6">
                          ...
                          <Field
                            ...
                            className={
                              "form-control" +
                              (errors.organiserName && touched.organiserName
                                ? " is-invalid"
                                : "")
                            }
                          />
                      ...
                      <div className="row">
                        <div className="form-group col-6">
                          ...
                          <br />
                          <br />
                          <label className="labelcolor">Date of event</label>
                        </div>
                        ...
                        <div className="form-group col-6">
                          <Field
                            ...
                            className={
                              "form-control" +
                              (errors.timeOfEvent && touched.timeOfEvent
                                ? " is-invalid"
                                : "")
                            }
                          />
                          ...
                          <br />
                          <br />
                          <label className="labelcolor"> Time</label>
                        </div>
                      </div>

                      <div className="row pt-3">
                        <div className="form-group col-12">
                          <label className="labelcolor">Upload Image</label>
                          <br />
                          <br />
                          <br />
                          <UploadImageAws />
